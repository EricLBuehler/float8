...
mod test {
    ...
    fn test_f8e4m3_consts_from_f32() {
        ...
        let inf = F8E4M3::from_f32(core::f32::INFINITY);
        let neg_inf = F8E4M3::from_f32(core::f32::NEG_INFINITY);
        let nan = F8E4M3::from_f32(core::f32::NAN);
        ...
        let e = F8E4M3::from_f32(core::f32::consts::E);
        let pi = F8E4M3::from_f32(core::f32::consts::PI);
        let frac_1_pi = F8E4M3::from_f32(core::f32::consts::FRAC_1_PI);
        let frac_1_sqrt_2 = F8E4M3::from_f32(core::f32::consts::FRAC_1_SQRT_2);
        let frac_2_pi = F8E4M3::from_f32(core::f32::consts::FRAC_2_PI);
        let frac_2_sqrt_pi = F8E4M3::from_f32(core::f32::consts::FRAC_2_SQRT_PI);
        let frac_pi_2 = F8E4M3::from_f32(core::f32::consts::FRAC_PI_2);
        let frac_pi_3 = F8E4M3::from_f32(core::f32::consts::FRAC_PI_3);
        let frac_pi_4 = F8E4M3::from_f32(core::f32::consts::FRAC_PI_4);
        let frac_pi_6 = F8E4M3::from_f32(core::f32::consts::FRAC_PI_6);
        let frac_pi_8 = F8E4M3::from_f32(core::f32::consts::FRAC_PI_8);
        let ln_10 = F8E4M3::from_f32(core::f32::consts::LN_10);
        let ln_2 = F8E4M3::from_f32(core::f32::consts::LN_2);
        let log10_e = F8E4M3::from_f32(core::f32::consts::LOG10_E);
        // core::f32::consts::LOG10_2 requires rustc 1.43.0
        let log10_2 = F8E4M3::from_f32(2f32.log10());
        let log2_e = F8E4M3::from_f32(core::f32::consts::LOG2_E);
        // core::f32::consts::LOG2_10 requires rustc 1.43.0
        let log2_10 = F8E4M3::from_f32(10f32.log2());
        let sqrt_2 = F8E4M3::from_f32(core::f32::consts::SQRT_2);
    ...
    fn test_f8e4m3_consts_from_f64() {
        ...
        let inf = F8E4M3::from_f64(core::f64::INFINITY);
        let neg_inf = F8E4M3::from_f64(core::f64::NEG_INFINITY);
        let nan = F8E4M3::from_f64(core::f64::NAN);
        ...
        let e = F8E4M3::from_f64(core::f64::consts::E);
        let pi = F8E4M3::from_f64(core::f64::consts::PI);
        let frac_1_pi = F8E4M3::from_f64(core::f64::consts::FRAC_1_PI);
        let frac_1_sqrt_2 = F8E4M3::from_f64(core::f64::consts::FRAC_1_SQRT_2);
        let frac_2_pi = F8E4M3::from_f64(core::f64::consts::FRAC_2_PI);
        let frac_2_sqrt_pi = F8E4M3::from_f64(core::f64::consts::FRAC_2_SQRT_PI);
        let frac_pi_2 = F8E4M3::from_f64(core::f64::consts::FRAC_PI_2);
        let frac_pi_3 = F8E4M3::from_f64(core::f64::consts::FRAC_PI_3);
        let frac_pi_4 = F8E4M3::from_f64(core::f64::consts::FRAC_PI_4);
        let frac_pi_6 = F8E4M3::from_f64(core::f64::consts::FRAC_PI_6);
        let frac_pi_8 = F8E4M3::from_f64(core::f64::consts::FRAC_PI_8);
        let ln_10 = F8E4M3::from_f64(core::f64::consts::LN_10);
        let ln_2 = F8E4M3::from_f64(core::f64::consts::LN_2);
        let log10_e = F8E4M3::from_f64(core::f64::consts::LOG10_E);
        // core::f64::consts::LOG10_2 requires rustc 1.43.0
        let log10_2 = F8E4M3::from_f64(2f64.log10());
        let log2_e = F8E4M3::from_f64(core::f64::consts::LOG2_E);
        // core::f64::consts::LOG2_10 requires rustc 1.43.0
        let log2_10 = F8E4M3::from_f64(10f64.log2());
        let sqrt_2 = F8E4M3::from_f64(core::f64::consts::SQRT_2);
    ...
    fn formatting() {
        ...
        assert_eq!(format!("{:.3}", f), "0.117");
        assert_eq!(format!("{:.4}", f), "0.1172");
        assert_eq!(format!("{:+.4}", f), "+0.1172");
        assert_eq!(format!("{:>+10.4}", f), "   +0.1172");
