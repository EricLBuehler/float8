...
fn test_sample_f8e4m3() {
    ...
    let _: F8E4M3 =
        rng.sample(rand_distr::Normal::new(F8E4M3::from_f32(0.0), F8E4M3::from_f32(1.0)).unwrap());
}
...
fn test_sample_f8e5m2() {
    ...
    #[cfg(feature = "num-traits")]
    let _: F8E5M2 =
        rng.sample(rand_distr::Normal::new(F8E5M2::from_f32(0.0), F8E5M2::from_f32(1.0)).unwrap());
}
